...
function WhoWeAre() {
  return (
    <section id="who-we-are" className="  lg:h-[650px] lg:w-full lg:flex lg:flex-col justify-center items-center lg:p-16 mb-28">
      <h1>Who we are</h1>
      <div className="mt-10 md:flex lg:flex lg:flex-row-reverse items-center justify-between  lg:p-10 p-5">
        ...
        <img src={whoweare} alt="whoweare" className="lg:mr-16 w-full h-full object-contain" />
      </div>
    </section>
  );
}
